            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <figcaption class="info">
                        ...
                        <p>Email: <?= Util::Print(Session::Get('email'));?>, Phone: <?= Util::Print(Session::Get('phone'));?>
                            <a href="#" class="px-2"><i class="fa fa-pen"></i></a>
                        </p>
                    </figcaption>
                    <hr>
                    <h4 class="card-title text-center">Invoices</h4>
                    <?php foreach ($invoice->GetInvoices() as $row) : ?>
                        ...
                        <div class="card-body">
                            <header class="d-lg-flex">
                                <div class="flex-grow-1">
                                    ...
                                    <?php if ($row->status == 0) : ?>
                                        <span class="text-danger"><?= Util::Print($invoice->GetInvoiceStatus($row->invoiceId)->status); ?></span>
                                    <?php else : ?>
                                        <span class="text-success"><?= Util::Print($invoice->GetInvoiceStatus($row->invoiceId)->status); ?></span>
                                    <?php endif; ?>
                                    </h6>
