...
if ($_SERVER['REQUEST_METHOD'] === 'POST')
{
    ...
    {
        $_POST['mOrderId'] = $id;
        $invoice->UpdateInvoiceStatus($_POST);
        UtiL::Redirect('/editinvoice');
    }
}
                            ...
                            <form method="POST">
                                <div class="form-group">
                                    <select class="form-select" aria-label="Default select example" name="mStatus">
                                        <option selected>Status Selection</option>
                                        <option value="0">Not Shipped</option>
                                        <option value="1">Shipped</option>
                                    </select>
                                </div>
                                <button class="btn btn-outline-primary btn-block" name="updatestatus" type="submit"
                                    value="submit">Update
                                </button>
                                                ...
                                                <td width="60%">
                                                    ...
                                                    <div class="product-qty">
                                                        <span class="d-block">Quantity:
                                                            <?= $productRow->quantity; ?></span>
                                                    </div>
                                                </td>
                                                <td width="20%">
                                                    <div class="text-right">
                                                        <span class="font-weight-bold"><?= $productRow->price; ?>
                                                            DKK</span>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tbody class="totals">
                                                ...
                                                <tr class="border-top border-bottom">
                                                    ...
                                                    <td>
                                                        <div class="text-right">
                                                            <span
                                                                class="font-weight-bold"><?= $invoiceRow->totalprice ?>
                                                                DKK</span>
                                                        </div>
                                                    </td>
                                                </tr>
