            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center text-lg text-medium"><?php echo ($v["price"]*$v["quantity"])." DKK"; ?></td>
                        <td class="text-center"><a class="remove-from-cart" href="cart/?action=remove&code=<?php echo $v["code"]; ?>" data-toggle="tooltip" title=""
